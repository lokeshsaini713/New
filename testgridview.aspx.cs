...
{
    private SqlConnection conn = new SqlConnection("Data Source=.;Integrated Security=true;Initial Catalog=GJS2019");
    ...
    {
        conn.Open();
        SqlCommand cmd = new SqlCommand("Select * from visitor1", conn);
